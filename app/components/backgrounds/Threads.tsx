...
float Perlin2D(vec2 P) {
  ...
  vec4 grad_x = hash_x - 0.49999; vec4 grad_y = hash_y - 0.49999;
...
export default function Threads({
  ...
  useEffect(() => {
    ...
    if (enableMouseInteraction) container.addEventListener("mousemove", handleMouseMove);
    ...
    return () => {
      ...
      if (enableMouseInteraction) container.removeEventListener("mousemove", handleMouseMove);
